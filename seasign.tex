...
The signature size of the basic scheme is rather large (around 19~KiB), since the sigma protocol that underlies the identification scheme only has single bit challenges. 
