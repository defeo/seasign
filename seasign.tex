...
Though see the earlier discussion and the work of Adj  et al.~\cite{adj+menezes+al-isogenies} that suggests this may be too cautious.
...
Note that we expect to be able to get smaller signatures at similar cost, but we choose these parameters to be able to recycle the running-time computations from~\cite{CLMPR18}.
