...
In Appendix~\ref{sec:lossy-keys} we show how to use our scheme in the context of lossy keys, from which we obtain tight security in the quantum random oracle model via the results of Kiltz, Lyubashevsky and Schaffner~\cite{KLS18}.
...
The table below states  $n\log B\sim \lambda^2$, which is not relevant in our situation as we base our security on a different assumption to other works.
