...
Note that this is still an order of magnitude smaller than the best stateless hash-based signature schemes (stateful hash-based signatures can be very short), and also still of the same size as the shortest known lattice-based signatures.
