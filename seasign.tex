...
% TODO: is "sigs" really acceptable?
...
% TODO: since we have unbaptized this problem, maybe we should also
% not name it "one ouf of..." in the sentence below:
The ``one out of $2^s$'' isogeny problem is to compute an ideal corresponding to any isogeny $E_{A,m} \to E_{A,m'}$ for some $m \ne m'$.
\end{problem}
...
\begin{enumerate}
  % TODO: Do we need this \item? We don't say anything new, one line would be enough.
  % At any rate, the style needs polishing
